...
//	vec3_print(vec3_create(x1, y1, z1), "1");
//	vec3_print(vec3_create(x2, y2, z2), "2");
...
void 	find_pixel_color(t_main *main)
{
	t_vec3 p;
//	double value;
	p.x = main->obj[main->curr].hitpoint.x;
	p.y = main->obj[main->curr].hitpoint.y;
	p.z = main->obj[main->curr].hitpoint.z;
...
//		main->obj[main->mode.obj_index].mat.color.x = value;
//		main->obj[main->mode.obj_index].mat.color.y = value;
//		main->obj[main->mode.obj_index].mat.color.z = value;
	}
